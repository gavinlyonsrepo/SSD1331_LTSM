/*!
	@file   SSD1331_LTSM.hpp
	@author Gavin Lyons
	@brief  Arduino library header file for ssd1331 OLED  SSD1331_LTSM library display.
*/
...
*/
class SSD1331_LTSM : public display16_graphics_LTSM
{
public:
	/*!
	...
	*/
	struct Constrast_values_t {
		uint8_t ContrastColorA ; /**< color A contrast normal mode */
		uint8_t ContrastColorB ; /**< color B contrast normal mode */
		uint8_t ContrastColorC ; /**< color C contrast normal mode */
	};
	/*!
		 @brief Set contrast color values in dim mode
	*/
	struct Dim_Constrast_values_t {
		uint8_t Dim_ContrastColorA ; /**< color A contrast dim mode */
		uint8_t Dim_ContrastColorB ; /**< color B contrast dim mode */
		uint8_t Dim_ContrastColorC ; /**< color C contrast dim mode */
	};

	SSD1331_LTSM(color_order_e, const Constrast_values_t& contrast, const Dim_Constrast_values_t& dimContrast);
	~SSD1331_LTSM(){};
